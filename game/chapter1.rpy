...
menu:
    "좋아! 나머지 부분 맡을게.":
        ...
        $ sena.increase_affection(1)  # 호감도 상승
        c "고마워! 함께 잘 준비하자!"
        p "세나는 내가 맡은 부분을 맡아줘서 고마운 듯 보였다."

    "이 부분하기 싫은데..":
        "[player_name]" "음... 나는 나머지 부분을 맡고 싶지 않아. 미안."
        $ sena.decrease_affection(1)  # 호감도 하락
        c "아, 그래? 그럼 다른 방식으로 나누자. 괜찮아."
        p "세나는 살짝 아쉬워하는 듯했지만, 그래도 다른 방법을 찾기로 했다."
        c "좋은 생각이야! 내가 결론을 맡고, 발표 마무리를 짧고 강렬하게 할 수 있게 준비할게."
        "[player_name]" "완벽하다! 그럼 각자 맡은 부분을 연습하면서 맞춰가자. 발표 때 긴장하지 말고 자연스럽게 하면 돼!"
