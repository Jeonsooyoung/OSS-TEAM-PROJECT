...
label chapter2:
    ...
    c "야, [player_name]! 다음 미션이 좀 어려울 것 같은데 너가 한 번 도전해볼래? "

    menu:
    "용감하게 자신이 해보겠다고 한다":
        "[player_name]" "내가 해볼게. 이왕 하는 거 재밌게 해야지!"
        s1 "좋아, 그럼 부탁한다! 우리 팀의 희망은 너야!"
        p "학생 1의 기대에 살짝 부담을 느꼈지만, [player_name]는 자신감을 내비치며 미션에 도전했다."
        p "결과는 대성공! 팀원들은 환호했고, [player_name]도 자신감을 얻었다."

    "학생 1에게 맡기며 장난스럽게 넘긴다":
        "[player_name]" "음… 넌 잘할 것 같은데? 내가 하면 팀 점수가 위험할 수도 있으니까 네가 하는 게 낫겠어!"
        s1 "야, 설마 나한테 미루는 거야? 알았어, 내가 한번 멋지게 해볼게!"
        p "학생 1이 멋지게 미션을 성공시키자, [player_name]는 안도의 한숨을 내쉬며 박수를 보냈다."
        p "[player_name]" "(그래, 팀워크란 게 바로 이런 거지. 맡길 건 맡기는 게 최선일 때도 있어.)"
