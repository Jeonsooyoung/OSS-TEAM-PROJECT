...
label chapter2:
    ...
    menu:
        ...
        "내 활약 보고 반해버려도 책임 못 진다?":
            ...
            "[player_name]" "흠, 이 정도는 기본이지. 내가 하니까 성공한거야~!"
    ...
    menu:
        ...
        "음 난 쉬고 싶어요~":
            ...
            "[player_name]"  "대신 지금은 좀 쉬는 시간이라구요~"
    ...
    "[player_name]" "바비큐가 시작되고, 우리는 고기를 구우며 서로 이야기를 나누었다."
    
    s "주인공! 고기 태우지 말고 맛있게 구워봐~ (웃음)"
    menu:
        "장난으로 맞받아친다":
            "나는 세나에게 장난스럽게 대꾸했다."
            s "아하하! 역시 재밌네."
    ...
    "잠시 후, 아리가 내게 쌈을 싸서 내밀었다."

    menu:
        "쌈을 받아 먹는다":
            "나는 아리가 준 쌈을 맛있게 먹었다."
            s2 "맛있지? 더 줄까?"
            "나는 고기를 아리의 접시에 올려주며 고마움을 표했다."
            return
    ...
    if affection_1 >= 10:
        "찬미누나가 편의점에 가서 아이스크림과 숙취 해소제를 사왔다."
        c "우리 잠깐 맥주 한 잔 더 하고 들어갈까요?"
        menu:
            "같이 간다":
                "나는 찬미누나와 함께 맥주를 마시며 대화를 나누었다."
                "찬미누나의 다양한 이야기를 들으며 더 가까워진 느낌이었다."
                return
