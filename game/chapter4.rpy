...
label chapter4:
    ...
    "[player_name]" "빨리 연락왔으면 좋겠다~~~"

    if affection_c >= 50:
    c "여기 음식 부스가 엄청 많아요! 같이 가서 뭐 먹어볼래요?"
    menu:
        "같이 간다":
            $ affection_c += 10
            p "좋아! 뭐부터 먹어볼까?"
            c "저기 보세요, 핫도그도 있고, 떡볶이도 있고... 음, 난 저 와플이 좀 끌리는데!"
            menu:
                "와플 먹자고 한다":
                    $ affection_c += 5
                    p "와플 좋아. 같이 먹자."
                    c "좋아! 나는 딸기 크림 얹은 걸로 할래. 너는?"
                    p "나는 초코 소스 잔뜩 얹은 걸로 할게."
                    c "역시 너도 단 걸 좋아하네! 이렇게 같이 먹으니까 더 맛있는 것 같아."
                "떡볶이를 추천한다":
                    p "와플도 좋지만, 떡볶이 한번 먹어볼래? 저기 줄 서 있는 거 보니까 엄청 인기 많아 보여."
                    c "그것도 좋지! 매운 거 잘 먹는 편이야?"
                    p "응, 매운 거 좋아해. 같이 먹으면 더 맛있을 거야."
                    c "그럼 얼른 가자! 네가 추천해준 거니까 더 기대된다."
        "거절한다":
            p "미안, 지금은 별로 배가 안 고파서. 나중에 먹으러 가자."
            c "아, 그래요? 알겠어요. 나중에 꼭 같이 해요."
else:
    p "학생 2는 혼자 음식 부스를 돌아다니며 음식을 고르고 있었다. 나는 잠시 멀리서 바라보다 다른 곳으로 갔다."
