...
label chapter4:
    $ load_game_state()
    $ sync_player_name()
    p "축제가 시작됐다. 캠퍼스는 사람들로 가득하고, 저마다 축제를 즐기고 있었다."

    # 학생 1 이벤트
    if affection_e >= 50:
        e "여기 좀 도와줄래요? 부스 꾸미는 게 손이 부족해요."
        menu:
            "도와준다":
                $ affection_e += 10
                p "그래, 나도 이런 거 잘하진 않지만 도울게."
                e "정말 고마워요! 함께하니까 훨씬 편해요."
                menu:
                    "게임 아이디어를 제안한다":
                        $ affection_e += 5
                        p "사람들이 참여할 수 있는 게임을 추가해 보면 어떨까?"
                        e "그거 정말 좋은 생각이에요. 역시 당신 덕분이에요!"
                    "휴게 공간 아이디어를 제안한다":
                        $ affection_e += 5
                        p "다들 쉬어갈 수 있는 공간을 만들어보자."
                        e "좋아요! 당신은 정말 센스가 좋네요."
                    "지금 상태로 충분하다 말한다":
                        p "지금 상태로도 충분해 보여."
                        e "알겠어요. 그래도 고마워요."
            "거절한다":
                p "미안, 지금은 좀 어려울 것 같아."
                e "괜찮아요. 다른 사람에게 부탁할게요."
    else:
        p "학생 1은 다른 사람들과 열심히 준비하고 있었다. 나는 그냥 지나쳤다."
